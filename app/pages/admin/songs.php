	...
	<section class="admin-content" style="min-height: 200px;">
	  			...
	  			<form method="post" enctype="multipart/form-data">
					...
					<div class="form-control my-1">
	  				...
	  				<a href="<?=ROOT?>/admin/songs">
	  					<button type="button" class="float-end btn">Trờ lại</button>
	  				</a>
	  			</form>
	  		</div>
  			...
  			<div style="max-width: 500px;margin: auto;">
	  			<form method="post" enctype="multipart/form-data">
					...
					<div class="form-control my-1">
	  				...
	  				<button class="btn bg-orange">Lưu thay đổi</button>
	  				<a href="<?=ROOT?>/admin/songs">
  		...
  		<?php else:?>
  			...
  			<h3>Bài Hát
  				<a href="<?=ROOT?>/admin/songs/add">
  					<button class="float-end btn bg-purple">Thêm bài mới</button>
  				</a>
  			</h3>
  	...
  	<div class="mx-2">
		...
		<a href="<?=ROOT?>/admin/songs?page=<?=$next_page?>">
			<button class="float-end btn bg-orange">Tiếp tục</button>
		</a>
	</div>
