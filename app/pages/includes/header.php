...
<html lang="vi">
<head>
    <title><?=ucfirst($URL[0])?> - Trang web âm nhạc</title>
    <meta charset="utf-8">
    ...
    <header>
        ...
        <div class="header-div">
            ...
            <div class="main-nav">
                ...
                <div class="nav-item"><a href="<?=ROOT?>/music">Âm nhạc</a></div>
                ...
                <?php if(logged_in()):?>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-list">
                            <div class="nav-item"><a href="<?=ROOT?>/admin/users/edit/<?=user('id')?>">Hồ sơ</a></div>
                            <div class="nav-item"><a href="<?=ROOT?>/admin">Quản trị</a></div>
